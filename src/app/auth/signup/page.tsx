...
export default function SignUpPage() {
  ...
  const handleJobSeekerSubmit = async (e: React.FormEvent) => {
    ...
    // Handle form validation and step progression
    ...
    try {
      ...
      console.log('Submitting job seeker registration:', payload);
      ...
      if (result.ok) {
        ...
        // Simple, reliable redirect after a delay
  ...
  const handleCompanySubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Company registration response:', result);
                    ...
                    {jobSeekerCurrentStep === 1 && (
                      <>
                        ...
                        <Button type="submit" className="w-full bg-teal-600 hover:bg-teal-700" disabled={isJobSeekerSubmitting}>
                          {isJobSeekerSubmitting ? "Submitting..." : "Sign Up"}
                        </Button>
                    ...
                    {jobSeekerCurrentStep === 3 && (
                      <>
                        ...
                        <Input
                          ...
                          value={jobSeekerData.personalWebsite}
                          onChange={(e) => setJobSeekerData({ ...jobSeekerData, personalWebsite: e.target.value })}
                        />
                        <textarea
                        ...
                        <FileUploadPlaceholder
                          ...
                          icon={FileText}
                          onFileChange={(file) => setJobSeekerData({ ...jobSeekerData, cv: file })}
                        />
                        <div className="flex justify-between gap-4">
                          <div className="flex flex-col w-full gap-4">
                            <Button
                      ...
                      <>
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => setCompanyData({ ...companyData, agreeToTerms: !!checked })}
                          />
                          <label className="text-sm text-gray-600">
                            I agree to the{" "}
                            <Link href="/terms" className="text-teal-600 underline">
                        ...
                        <Button type="submit" className="w-full bg-teal-600 hover:bg-teal-700" disabled={isCompanySubmitting}>
                          {isCompanySubmitting ? "Submitting..." : "Sign Up"}
                        </Button>
                        <div className="text-center mt-2 pt-2 border-t">
                          <p className="text-gray-600">
                            Already a user?{" "}
